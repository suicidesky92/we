...
apt install -y xarchiver pcmanfm xfce4-clipman compton gnome-screenshot suckless-tools surf lxappearance lxappearance-obconf gnome-calculator kazam
apt install -y firefox-esr evince libreoffice lightdm-gtk-greeter lightdm-gtk-greeter-settings chromium
...
wget https://atom.io/download/deb; dpkg -i atom-amd64.deb
